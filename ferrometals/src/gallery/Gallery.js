        ...
        <section className="Standart-Section Gallery-Container">
            ...
            <div className="Gallery-Inner-Container">
                <Link onClick={linkScroll} className='Gallery-Link' to={data.menuPaths.photo}>
                        <img className="Gallery-Link-Image Gallery-Link-Image-Photo" 
                        src={require(`../data/photo/photo_photogallery/${data.gallery.photoPath}`)} 
                        alt={data.gallery.photoAltText}></img>
                ...
                <Link onClick={linkScroll} className='Gallery-Link' to={data.menuPaths.video}>
                        <video className="Gallery-Link-Image" src={require(`../data/video/${data.gallery.videoPath}`)} 
                        preload="true" autoPlay muted type="video/mp4">
