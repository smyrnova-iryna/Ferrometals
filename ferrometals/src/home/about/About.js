            ...
            <div className="About-Text-Container Extra-Text-Container Center-Block-Part">
                ...
                <div className="About-List">
                    {data.about.listItems.map((item) => 
                        <p key={item} className="About-General-Text About-List-Item"><img className='First-Page-List-Gear-Icon' alt="Icon" src={require("../../img/gear.png")}></img> <span>{item}</span></p>
                    )}
                </div>
                <p className="About-General-Text About-Detailed-Info About-List-Item">
                    <svg fill="rgba(20,172,147,255)" height="40px" width="40px" version="1.1" id="Layer_1"  viewBox="0 0 511.999 511.999" stroke="rgba(20,172,147,255)">
