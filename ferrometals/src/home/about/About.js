            ...
            <div className="About-Text-Container Extra-Text-Container Center-Block-Part">
                ...
                <div className="About-List">
                    {data.about.listItems.map((item) => 
                        <p key={item} className="About-General-Text About-List-Item"><span className="About-List-Item-Marker">&#10004;</span><span className="About-List-Item-Text">{item}</span></p>
             ...
             <div className="About-Text-Container Options-Main-Container Bottom-Block-Part">
                <div className="About-Text-Adaptive-Container">
                    <div className="About-Product-Options-Container">
                        ...
                        <div className="About-Product-Options-Inner-Container">
                            ...
                            <a className="About-Product-Options-Button" href={require(`../../booklets/${data.booklets.polymerCoatingLines.path}`)} //Замінити
                ...
                <div className="About-Text-Adaptive-Container">
                    ...
                    <div className="About-Product-Options-Container About-Last-Container">
                        <h4 className="About-Product-Options-Title">{data.booklets.polymerCoatingLines.product}</h4>
                        <img className="About-Product-Options-Image" alt={data.polymerCoatingLines.mainHeader}
                        src={require(`../../data/picture/picture_products/${data.roundWoodAccountingScanner.pictures[0].picture}`)}></img>
                        <div className="About-Product-Options-Inner-Container">
                            <a className="About-Product-Options-Button" href={require(`../../booklets/${data.booklets.polymerCoatingLines.path}`)} 
                            download={data.booklets.polymerCoatingLines.title}>{data.booklets.title}</a>
                            <Link className="About-Product-Options-Button"  to={data.menuPaths.polymerCoatingLines} onClick={linkScroll}>
