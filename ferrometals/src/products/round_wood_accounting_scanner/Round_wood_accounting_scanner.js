        ...
        <section className="Standart-Section Product-Container">
            ...
            <article className="Product-Info-Container">
                ...
                <div className="Scaner-Decorated-Right-Text-Container">
                    <svg className="Pulse-Icon" fill="rgba(20,172,147,255)" height="80px" width="80px" version="1.1" id="Layer_1"  viewBox="0 0 511.999 511.999" stroke="rgba(20,172,147,255)">
